...
public class Pet {
  ...
  // todo: toString() method is causing StackOverflowError when accessing owner by pet id from db
  // hint: I think this is related to Comparable interface in Customer class
/*
      @Override
